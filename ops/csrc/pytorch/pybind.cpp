...
void general_deform_roi_pool_backward(Tensor grad_output, Tensor input, Tensor rois, Tensor rescale,
                              Tensor offset, Tensor grad_input, Tensor grad_rescale, Tensor grad_offset, 
                              int pooled_height, int pooled_width, float spatial_scale, int sampling_ratio, 
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("general_deform_roi_pool_forward", &general_deform_roi_pool_forward,
        "general_deform roi pool forward", py::arg("input"), py::arg("rois"),
        py::arg("rescale"), py::arg("offset"), py::arg("output"), py::arg("pooled_height"),
        py::arg("pooled_width"), py::arg("spatial_scale"),
        py::arg("sampling_ratio"), py::arg("gamma"), py::arg("sigma"), py::arg("beta"));
  m.def("general_deform_roi_pool_backward", &general_deform_roi_pool_backward,
        "general_deform roi pool backward", py::arg("grad_output"), py::arg("input"),
        py::arg("rois"), py::arg("rescale"), py::arg("offset"), py::arg("grad_input"),
        py::arg("grad_rescale"), py::arg("grad_offset"), py::arg("pooled_height"),
        py::arg("pooled_width"), py::arg("spatial_scale"),
        py::arg("sampling_ratio"), py::arg("gamma"), py::arg("sigma"), py::arg("beta"));
}
