...
from .rescale_roi_head import RescaleRoIHead
from .general_deformable_roi_head import GeneralDeformableRoIHead
...
__all__ = [
    ...
    'FeatureRelayHead', 'GlobalContextHead', 'RescaleRoIHead', 'GeneralDeformableRoIHead'
]
